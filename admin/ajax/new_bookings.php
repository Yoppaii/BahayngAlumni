...
if (isset($_POST['get_bookings'])) {
    ...
    while ($data = mysqli_fetch_assoc($res)) {
        ...
        <tr>
            ...
            <td>
            <button type='button' onclick='assign_room($data[booking_id])' class='btn text-white btn-sm fw-bold custom-bg shadow-none' data-bs-toggle='modal' data-bs-target='#assign_room'>
