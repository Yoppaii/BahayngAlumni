...
<body class="bg-light">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="name" class="form-control shadown-none" required>

                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold">Area</label>
                                <input type="text" min="1" name="area" class="form-control shadown-none" required>

                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold">Price</label>
                                <input type="text" min="1" name="price" class="form-control shadown-none" required>

                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold">Quantity</label>
                                <input type="text" min="1" name="quantity" class="form-control shadown-none" required>
    ...
    <!-- Edit Room Image Section -->
    <div class="modal fade" id="edit_room_image" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="border-bottom border-3 pb-3 mb-3">
                        <form id="add_image_form">
                            ...
                            <input type="file" name="image" accept=".jpg, .png, .webp, .jpeg" class="form-control shadown-none mb-3" required>
    ...
    <script src="page-scripts/rooms.js"></script>
</body>
